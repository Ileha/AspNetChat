...
using UserConnectedMongo = Mongo.Entities.UserJoined;
using UserDisconnectedMongo = Mongo.Entities.UserDisconnected;
using UserSendMessageMongo = Mongo.Entities.UserSendMessage;
using UserConnected = Chat.Entities.ChatModel.Events.UserConnected;
